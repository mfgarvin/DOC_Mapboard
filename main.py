...
#       print("This is the weekday!", weekday)
     else:
      time.sleep(1)
...
def wakeUpParish():
 for parishID in allocation:
  ...
  # print(i[1])
#        for n in range(0,5): #ideally, for n in list of parish IDs...
#                threading.Thread(target=thePastor, args=(id)).start()
